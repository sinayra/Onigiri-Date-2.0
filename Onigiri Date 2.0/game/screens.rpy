        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Avançar")
                    textbutton _("Diálogos não vistos") action Preference("skip", "toggle")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança diálogos e ativa interface")

    hbox:
        label _("Espaço")
        text _("Avança diálogos sem escolher opções")
    ...
    hbox:
        label "V"
        text _("Ativa ou desativa {a=https://www.renpy.org/l/voicing}self-voicing{/a}.")
